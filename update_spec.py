...
# The complete new spec from the user
new_spec = {
  "openapi": "3.1.1",
  "info": {
  ...
  "servers": [
    {
      "url": "https://virtserver.swaggerhub.com/mining_development_kit_api/1.4.1",
...
# Write the basic structure first
with open('spec_new.json', 'w') as f:
    json.dump(new_spec, f, indent=2)

print("Basic spec structure written successfully!")
